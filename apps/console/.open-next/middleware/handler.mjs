...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[727], { 67: (e) => {
      ...
      r.r(m), r.d(m, { config: () => eH, middleware: () => eB });
      let b = null;
      function v() {
        return b || (b = w()), b;
      }
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let eU = ["/dashboard", "/admin"];
      function eB(e2) {
        let { pathname: t2 } = e2.nextUrl;
        if (!eU.some((e3) => t2.startsWith(e3))) return Y.next();
        let r2 = e2.cookies.get("wokspec_session");
        if (!r2?.value) {
      ...
      let eH = { matcher: ["/dashboard/:path*", "/admin/:path*"] }, e$ = { ...m }, eV = e$.middleware || e$.default, ez = "/src/middleware";
      if ("function" != typeof eV) throw Error(`The Middleware "${ez}" must export a \`middleware\` or a \`default\` function`);
      function eF(e2) {
        return eD({ ...e2, page: ez, handler: eV });
      }
    }, 775: (e) => {
      "use strict";
      ...
      (() => {
        var o = { 226: function(o2, i2) {
          !function(a2, s2) {
            "use strict";
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", h = "model", f = "name", g = "type", m = "vendor", w = "version", b = "architecture", v = "console", y = "mobile", x = "tablet", S = "smarttv", _ = "wearable", R = "embedded", C = "Amazon", k = "Apple", E = "ASUS", N = "BlackBerry", T = "Browser", P = "Chrome", O = "Firefox", A = "Google", L = "Huawei", I = "Microsoft", M = "Motorola", j = "Opera", q = "Samsung", D = "Sharp", U = "Sony", B = "Xiaomi", H = "Zebra", $ = "Facebook", V = "Chromium OS", z = "Mac OS", F = function(e2, t2) {
              var r2 = {};
              ...
              return this.getBrowser = function() {
                ...
                var e3 = {};
                return e3[f] = s2, e3[w] = s2, Y.call(e3, n2, i3.os), v2 && !e3[f] && o3 && "Unknown" != o3.platform && (e3[f] = o3.platform.replace(/chrome os/i, V).replace(/macos/i, z)), e3;
      ...
      function y(e3, t2, r2) {
        var n2 = g("diag");
        if (n2) return r2.unshift(t2), n2[e3].apply(n2, b([], w(r2), false));
      }
      !function(e3) {
      ...
      var A = new function e3(t2) {
        ...
        return M(t2, e3), t2;
      }($), W = new j(), G = new D(), X = new B(), K = new H(), Y = new U(), Z = new V(), J = new z(), Q = new F();
      function ee() {
        return W;
      }
      !function(e3) {
      ...
      var eZ = "propagation", eJ = new eF(), eQ = function() {
        function e3() {
          this.createBaggage = T, this.getBaggage = eG, this.getActiveBaggage = eX, this.setBaggage = eK, this.deleteBaggage = eY;
        }
        return e3.getInstance = function() {
          return this._instance || (this._instance = new e3()), this._instance;
...
var init_edgeFunctionHandler = __esm({
  "../../node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$"] }];
...
var BuildId = "0X_JSH17Q1AHDf5xYj6jH";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/clients/new", "regex": "^/admin/clients/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/clients/new(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/dashboard/ai", "regex": "^/dashboard/ai(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/ai(?:/)?$" }, { "page": "/dashboard/automations", "regex": "^/dashboard/automations(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/automations(?:/)?$" }, { "page": "/dashboard/crm", "regex": "^/dashboard/crm(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/crm(?:/)?$" }, { "page": "/dashboard/settings", "regex": "^/dashboard/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard/settings(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }], "dynamic": [], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/api/ghl/contacts": { "initialHeaders": { "content-type": "application/json", "x-next-cache-tags": "_N_T_/layout,_N_T_/api/layout,_N_T_/api/ghl/layout,_N_T_/api/ghl/contacts/layout,_N_T_/api/ghl/contacts/route,_N_T_/api/ghl/contacts" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/api/ghl/contacts", "dataRoute": null }, "/api/ghl/pipelines": { "initialHeaders": { "content-type": "application/json", "x-next-cache-tags": "_N_T_/layout,_N_T_/api/layout,_N_T_/api/ghl/layout,_N_T_/api/ghl/pipelines/layout,_N_T_/api/ghl/pipelines/route,_N_T_/api/ghl/pipelines" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/api/ghl/pipelines", "dataRoute": null }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc" }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc" } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "6518bc9adf16b7b50bbc852a548a0676", "previewModeSigningKey": "eb50e3ddddb28e162e025d9d4c1131b4a483d3bcb3b88761db23aa6f18c6bfe4", "previewModeEncryptionKey": "f75fc7c5819c89818a20cb8b3670a1188c279796f8d38590992ccb5e867ca19f" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "originalSource": "/dashboard/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "0X_JSH17Q1AHDf5xYj6jH", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "rizLEzzNoMWfYGBg0pp+6YOwv2Xd0CX41XgCy/hYIZY=", "__NEXT_PREVIEW_MODE_ID": "6518bc9adf16b7b50bbc852a548a0676", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "f75fc7c5819c89818a20cb8b3670a1188c279796f8d38590992ccb5e867ca19f", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "eb50e3ddddb28e162e025d9d4c1131b4a483d3bcb3b88761db23aa6f18c6bfe4" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/eral/chat/route": "/api/eral/chat", "/api/admin/clients/route": "/api/admin/clients", "/api/ghl/automations/route": "/api/ghl/automations", "/api/ghl/contacts/route": "/api/ghl/contacts", "/login/page": "/login", "/api/ghl/pipelines/route": "/api/ghl/pipelines", "/page": "/", "/(console)/admin/page": "/admin", "/(console)/admin/clients/new/page": "/admin/clients/new", "/(console)/dashboard/automations/page": "/dashboard/automations", "/(console)/dashboard/crm/page": "/dashboard/crm", "/(console)/dashboard/page": "/dashboard", "/(console)/dashboard/settings/page": "/dashboard/settings", "/(console)/dashboard/ai/page": "/dashboard/ai" };
