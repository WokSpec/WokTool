...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Sprite Sheet Packer — WokTool', description: 'Pack sprites into an optimized atlas. Export PNG + TexturePacker/CSS/JSON manifest. Free.', type: 'website' },
};
