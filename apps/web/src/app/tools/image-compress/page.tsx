...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Image Compressor — WokTool', description: 'Compress images with quality control. Live before/after size preview. Free, browser-native.', type: 'website' },
};
